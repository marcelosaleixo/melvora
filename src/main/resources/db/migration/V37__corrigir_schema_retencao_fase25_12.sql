-- FASE 25.12 - correção definitiva do schema de retenção
-- Esta migration é idempotente para recuperar bancos em que V35/V36
-- foram registradas/aplicadas parcialmente sem todas as colunas físicas.
