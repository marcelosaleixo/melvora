-- Correção defensiva da FASE 22.
-- Garante a existência da tabela mesmo em bancos nos quais a V20
-- tenha sido registrada/aplicada sem criar a estrutura esperada.
CREATE TABLE IF NOT EXISTS templates_whatsapp (
    ...
    CONSTRAINT fk_template_whatsapp_empresa FOREIGN KEY (empresa_id)
